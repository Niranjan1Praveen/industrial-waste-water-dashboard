    ...
    subCategories: [
      {
        ...
        challenges: [
          ...
          "Managing massive foaming in aeration tanks due to surfactants",
        ],
      ...
      },
      {
        ...
        name: "Home Care",
        challenges: [
          "Removing high levels of chemical phosphates",
      ...
      },
      {
        ...
        challenges: [
          ...
          "Handling compounds that easily bypass standard grit separation",
        ],
